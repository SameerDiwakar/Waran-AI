      ...
      <footer className="bg-gray-100 py-12">
        <div className="waranai-container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
              ...
              <p className="mt-4 text-gray-600">
                AI-powered warranty management to help you get the most out of your purchases.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/help" className="text-gray-600 hover:text-brand-purple">Help Center</Link></li>
                <li><Link to="/contact" className="text-gray-600 hover:text-brand-purple">Contact Us</Link></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600">&copy; {new Date().getFullYear()} WaranAI. All rights reserved.</p>
